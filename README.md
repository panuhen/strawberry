...
- **Type to her** — `bin/strawberry talk` opens a prompt; each line goes through the daemon exactly like a spoken sentence (gate, reflexes, Qwen) and she answers on the desktop and in the terminal, with the routing shown underneath.
