...
def test_shipped_routing_questions_are_well_formed():
    ...
    assert names == ["kind", "topic", "is_urgent", "is_about_her", "has_argument", "music_tool"]
...
async def test_gate_routes_and_logs_a_request():
    ...
    assert set(route.answers) == {"kind", "topic", "is_urgent", "is_about_her", "has_argument", "music_tool"}
