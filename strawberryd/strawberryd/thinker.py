...
SYSTEM = (
    ...
    "given below, or a well-known artist, assume that is what they said and search for that. But if the only "
    "match is an obscure name that merely resembles the words, do not play it: say what you heard and what you "
    "think they meant, and do nothing. 'This song', 'this', 'it' mean whatever is playing now (given "
